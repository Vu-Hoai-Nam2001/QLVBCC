...
export default function index() {
    ...
    const callApithongke = async () => {
        ...
        await fetch(`https://qlvbcc.hasura.app/api/rest/getsoluuvanbangchungchi/${datebatdau}/${dateketthuc}/${selectedItem2}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'x-hasura-admin-secret': 'SeALKpEjjdBd2xlGyBXtGPjU9C46BocE6P3DERIgB8sJhPGvUH57qvh7QnMW4e9c',
            ...
            .then(datathongke => {
                ...
                setDatathongke(datathongke.soluuvanbangchungchi)
            });
    }
        ...
        <div className="flex flex-col  mt-[30px] w-[1300px] max-w[100%] mx-auto mb-[15px] min-h-[420px]">
            ...
            {showssoluu && <div className="flex flex-col">
                ...
                <div className="flex ml-[10%]">
                    ...
                    <div className="w-[35%] ml-[20%] flex flex-col">
                        ...
                        <input value={solancap} onChange={e => setSolancap(e.target.value)} className="w-full pl-[10px] h-[35px] rounded-[8px] border border-black mt-[5px] " placeholder="Lần cấp thứ:" />
            ...
            {showsthongke && <div className="flex flex-col">
                <div className="flex flex-col ml-[10%]">
                    ...
                    setShowthongkeloc(true) }}>Duyệt</button>
                    </div>
