...
export default function Index(props) {
    ...
    const [dataluuminhchung, setDataluuminhchung] = useState()
    ...
    const callApiluuminhchung = async () => {

        await fetch(`https://qlvbcc.hasura.app/api/rest/luuminhchung`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'x-hasura-admin-secret': 'SeALKpEjjdBd2xlGyBXtGPjU9C46BocE6P3DERIgB8sJhPGvUH57qvh7QnMW4e9c',
            ...
            .then(response => response.json())
            .then(dataluuminhchung => {
                // setTendetai(datasv.f_get_ttsv5[0].tendetai)
                setDataluuminhchung(dataluuminhchung.returning.id)
            });
    }
    ...
    useEffect(() => {
        ...
        const callApi = async () => {
            ...
            await fetch(`https://qlvbcc.hasura.app/api/rest/get_minhchung/${props.data}/vanbang`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'x-hasura-admin-secret': 'SeALKpEjjdBd2xlGyBXtGPjU9C46BocE6P3DERIgB8sJhPGvUH57qvh7QnMW4e9c',
    ...
    const newfileggdrive = async () => {
        ...
        await fetch(`/../../api/newfileggdrive`, {
            ...
            .then(response => response.json())
            .then(dataurlqrcode => {
                setDataurlqrcode(dataurlqrcode.result.id)
            });
        ...
        <div >
            ...
            {datasv && datasv.map((sinhvien, index) => (
                <div key={index} className=" mt-[10px] justify-center" >
                    ...
                    <div className="flex justify-center text-[30px] font-semibold text-[#0083c2]">BỔ SUNG MINH CHỨNG VĂN BẰNG</div>
